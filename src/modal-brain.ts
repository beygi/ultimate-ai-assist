...
function createBrainBtn(x: number, y: number) {
  ...
  btn.addEventListener('click', (e) => {
    e.stopPropagation();
    document.dispatchEvent(new CustomEvent('ai-text-helper-brain-btn-click'));
    removeBrainBtn();
  });
...
document.addEventListener('ai-text-helper-brain-btn-click', () => {
  // Simulate shortcut: dispatch the same event as the keyboard shortcut handler expects
